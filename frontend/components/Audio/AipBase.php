...
namespace frontend\components\Audio;

use frontend\components\Audio\AipHttpClient;
use frontend\components\Audio\AipHttpUtil;
use frontend\components\Audio\AipImageUtil;
